...
void main() {
  WeightEntry activeEntry = new WeightEntry(new DateTime.now(), 160.0, null, null);
  WeightEntryDialogReduxState dialogState = new WeightEntryDialogReduxState(isEditMode: true, activeEntry: activeEntry);
  ...
  testWidgets('WeightEntryDialog has "New entry" in header', (WidgetTester tester) async {
    await pumpSettingWidget(
        new Store<ReduxState>(reduce, initialState: defaultState.copyWith(weightEntryDialogState: dialogAddState)),
        tester);

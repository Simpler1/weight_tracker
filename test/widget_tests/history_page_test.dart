...
void main() {
  ...
  pumpSettingWidget(Store<ReduxState> store, WidgetTester tester) async {
    await tester.pumpWidget(new StatefulBuilder(builder: (BuildContext context, StateSetter setState) {
  ...
  testWidgets('HistoryPage has text if there are no entries', (WidgetTester tester) async {
    await pumpSettingWidget(new Store<ReduxState>(reduce, initialState: defaultState.copyWith(entries: [])), tester);
